...
class ConvAutoencoderLuma5(nn.Module):
    def __init__(self):
        super(ConvAutoencoderLuma5, self).__init__()
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ReLU(),
            nn.ConvTranspose2d(in_channels=64, out_channels=1, kernel_size=2, stride=1, padding=0),
            nn.Sigmoid()
...
if __name__ == '__main__':
    ...
    model = ConvAutoencoderLuma5().to(device).eval()
