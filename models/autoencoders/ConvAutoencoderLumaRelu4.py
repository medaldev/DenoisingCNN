...
class ConvAutoencoderLumaRelu4(nn.Module):
    def __init__(self):
        super(ConvAutoencoderLumaRelu4, self).__init__()

        # Encoder
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=8048, kernel_size=3, stride=1, padding=1)
        self.conv2 = nn.Conv2d(in_channels=8048, out_channels=2048, kernel_size=2, stride=1, padding=0)
        self.conv3 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=1, padding=0)
        self.conv4 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=1, padding=0)
        self.conv5 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=1, padding=0)
        self.conv6 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=1, padding=0)
        self.conv7 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=1, padding=0)
        self.conv8 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=1, padding=0)
        self.conv9 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=2, padding=0)
        self.conv10 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=2, padding=0)
        self.conv11 = nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=2, stride=2, padding=0)

        self.flatten1 = nn.Flatten()

        self.ln1 = nn.Linear(8192, 8192)
        self.ln2 = nn.Linear(8192, 8192)
        self.ln3 = nn.Linear(8192, 8192)
...
if __name__ == '__main__':
    model = ConvAutoencoderLumaRelu4().eval()
