...
class AEv3_0(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(AEv3_0, self).__init__()

        self.in_channels = in_channels
        self.out_channels = out_channels

        self.conv0 = nn.Conv2d(in_channels=in_channels, out_channels=256, kernel_size=3, stride=1, padding=1)
        ...
        self.conv_transpose5 = nn.ConvTranspose2d(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.conv_transpose6 = nn.ConvTranspose2d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding=1)
        self.conv_transpose7 = nn.ConvTranspose2d(in_channels=256, out_channels=out_channels, kernel_size=3, stride=1, padding=1)
...
if __name__ == '__main__':
    ...
    model = AEv3_0(1, 1).to(device).eval()
