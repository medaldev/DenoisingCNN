...
class ConvAutoencoderLumaRelu2(nn.Module):
    def __init__(self):
        super(ConvAutoencoderLumaRelu2, self).__init__()
        ...
        self.conv7 = nn.Conv2d(in_channels=1024, out_channels=2048, kernel_size=2, stride=1, padding=0)
...
if __name__ == '__main__':
    model = ConvAutoencoderLumaRelu2().eval()
