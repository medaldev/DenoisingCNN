...
class ConvAutoencoderLumaRelu8(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(ConvAutoencoderLumaRelu8, self).__init__()
...
if __name__ == '__main__':
    ...
    model = ConvAutoencoderLumaRelu8(in_channels=1, out_channels=1).to(device).eval()
